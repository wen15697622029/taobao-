...
<div id="d">
    ...
    <div id="d4">
        ...
        <a href="fhAdmin" style="color: red">发货</a>
    </div>
    <div id="d3">
        <div id="d31">
            <table>
...
<c:forEach items="${sessionScope.orders}" var="order" varStatus="loop">
                <tr >
                    ...
                    <form method="post" action="fhOrders">
                        <td>
                            <input name="ordersId" type="hidden" value="${order.id}">
                            <input type="submit" value="发货"></td>
                    </form>
                </tr>
        ...
        <div id="d32" >
            <a href="fhAdmin?currentPage=${sessionScope.currentPage-1==0?sessionScope.currentPage:sessionScope.currentPage-1}">上一页</a>
            <a href="fhAdmin?currentPage=${sessionScope.currentPage}">第${sessionScope.currentPage}页</a>
            共${sessionScope.totalPages}页
            <a href="fhAdmin?currentPage=${sessionScope.currentPage+1>sessionScope.totalPages?sessionScope.currentPage:sessionScope.currentPage+1}">下一页</a>
            <form action="fhAdmin" method="post">
