...
<div id="d">
    ...
    <div id="d4">
        <a href="admin" style="color: red">所有商品</a>
        <a href="sjAdmin">上架</a>
        <a href="xjAdmin">下架</a>
    </div>
    <div id="d3">
...
<c:forEach items="${sessionScope.goods}" var="good" varStatus="loop">
        ...
        <div id="d32" >
            <a href="admin?currentPage=${sessionScope.currentPage-1==0?sessionScope.currentPage:sessionScope.currentPage-1}">上一页</a>
            <a href="admin?currentPage=${sessionScope.currentPage}">第${sessionScope.currentPage}页</a>
            共${sessionScope.totalPages}页
            <a href="admin?currentPage=${sessionScope.currentPage+1>sessionScope.totalPages?sessionScope.currentPage:sessionScope.currentPage+1}">下一页</a>
