...
<div id="d">
    ...
    <div id="d4">
        ...
        <a href="dfhOrders" style="color: red">待发货</a>
...
<c:forEach items="${sessionScope.orders}" var="order" varStatus="loop">
                <tr >
                    ...
                    <form method="post" action="tkOrder">
                    <td>
                        <input name="ordersId" type="hidden" value="${order.id}">
                        <input type="submit" value="退款"></td>
                    </form>
                </tr>
    <div id="div${loop.count-1}" style="display:none;position:absolute;left: 10px;text-align: left">
        ...
        <div id="d32" >
            <a href="dfhOrders?currentPage=${sessionScope.currentPage-1==0?sessionScope.currentPage:sessionScope.currentPage-1}">上一页</a>
            <a href="dfhOrders?currentPage=${sessionScope.currentPage}">第${sessionScope.currentPage}页</a>
            共${sessionScope.totalPages}页
            <a href="dfhOrders?currentPage=${sessionScope.currentPage+1>sessionScope.totalPages?sessionScope.currentPage:sessionScope.currentPage+1}">下一页</a>
            <form action="dfhOrders" method="post">
