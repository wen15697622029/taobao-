...
<div id="d">
    <div id="d1">
        ...
        <div id="d12">
            ...
            <a href="tkAdmin" style="color: red">退款处理&emsp;</a>
        </div>
    </div>
...
<c:forEach items="${sessionScope.orders}" var="order" varStatus="loop">
                <tr >
                    ...
                    <form method="post" action="tyAdmin">
                    <td><input type="hidden" name="ordersId" value="${order.id}"/>
                        <input type="submit" value="同意"></td>
                    </form>
                </tr>
        ...
        <div id="d32" >
            <a href="tkAdmin?currentPage=${sessionScope.currentPage-1==0?sessionScope.currentPage:sessionScope.currentPage-1}">上一页</a>
            <a href="tkAdmin?currentPage=${sessionScope.currentPage}">第${sessionScope.currentPage}页</a>
            共${sessionScope.totalPages}页
            <a href="tkAdmin?currentPage=${sessionScope.currentPage+1>sessionScope.totalPages?sessionScope.currentPage:sessionScope.currentPage+1}">下一页</a>
            <form action="tkAdmin" method="post">
