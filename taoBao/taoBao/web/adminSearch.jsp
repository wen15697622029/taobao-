            ...
            <table>
                ...
                <c:forEach items="${sessionScope.goods}" var="good" varStatus="loop">
                    <tr >
                        ...
                        <td>${good.state==1?"上架":"下架"}</td>
                    </tr>
                </c:forEach>
            </table>
        </div>
        <div id="d32" >
            <a href="adminSearch?name=${sessionScope.name}&currentPage=${sessionScope.currentPage-1==0?sessionScope.currentPage:sessionScope.currentPage-1}">上一页</a>
            <a href="adminSearch?name=${sessionScope.name}&currentPage=${sessionScope.currentPage}">第${sessionScope.currentPage}页</a>
            共${sessionScope.totalPages}页
            <a href="adminSearch?name=${sessionScope.name}&currentPage=${sessionScope.currentPage+1>sessionScope.totalPages?sessionScope.currentPage:sessionScope.currentPage+1}">下一页</a>
