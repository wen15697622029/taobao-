...
<div id="d">
    ...
    <div id="d4">
        ...
        <a href="dpjOrders" style="color: red">待评价</a>
    ...
    <div id="d3">
            ...
            <table >
                ...
                <c:forEach items="${sessionScope.orders}" var="order" varStatus="loop">
                    <tr >
                        ...
                        <form method="post" action="pjOrder">
                        <td>
                            <input name="pjOrdersId" type="hidden" value="${order.id}">
                            <input type="submit" value="评价"></td>
                    </form>
                </tr>
        ...
        <div id="d32" >
            <a href="dpjOrders?currentPage=${sessionScope.currentPage-1==0?sessionScope.currentPage:sessionScope.currentPage-1}">上一页</a>
            <a href="dpjOrders?currentPage=${sessionScope.currentPage}">第${sessionScope.currentPage}页</a>
            共${sessionScope.totalPages}页
            <a href="dpjOrders?currentPage=${sessionScope.currentPage+1>sessionScope.totalPages?sessionScope.currentPage:sessionScope.currentPage+1}">下一页</a>
            <form action="dpjOrders" method="post">
