...
<div id="d">
    ...
    <div id="d4">
        ...
        <a href="dshOrders" style="color: red">待收货</a>
...
<c:forEach items="${sessionScope.orders}" var="order" varStatus="loop">
                ...
                <form action="qrshOrders" method="post">
    ...
    <div id="div${loop.count-1}" style="display:none;position:absolute;left: 10px;text-align: left">
        ...
        <div id="d32" >
            <a href="dshOrders?currentPage=${sessionScope.currentPage-1==0?sessionScope.currentPage:sessionScope.currentPage-1}">上一页</a>
            <a href="dshOrders?currentPage=${sessionScope.currentPage}">第${sessionScope.currentPage}页</a>
            共${sessionScope.totalPages}页
            <a href="dshOrders?currentPage=${sessionScope.currentPage+1>sessionScope.totalPages?sessionScope.currentPage:sessionScope.currentPage+1}">下一页</a>
            <form action="dshOrders" method="post">
