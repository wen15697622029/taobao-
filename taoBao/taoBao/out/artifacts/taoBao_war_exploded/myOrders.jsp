...
<div id="d">
    ...
    <div id="d4">
        <a href="myOrders" style="color: red">所有订单</a>
...
<c:forEach items="${sessionScope.orders}" var="order" varStatus="loop">
        ...
        <div id="d32" >
            <a href="myOrders?currentPage=${sessionScope.currentPage-1==0?sessionScope.currentPage:sessionScope.currentPage-1}">上一页</a>
            <a href="myOrders?currentPage=${sessionScope.currentPage}">第${sessionScope.currentPage}页</a>
            共${sessionScope.totalPages}页
            <a href="myOrders?ordersPage=${sessionScope.currentPage+1>sessionScope.totalPages?sessionScope.currentPage:sessionScope.currentPage+1}">下一页</a>
