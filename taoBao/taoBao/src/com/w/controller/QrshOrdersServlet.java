...
/**
 * Created by destiny on 2018/6/28/0028.
 */
@WebServlet(name = "QrshOrdersServlet",urlPatterns = "/qrshOrders")
public class QrshOrdersServlet extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        response.sendRedirect("dpjOrders");
    }
